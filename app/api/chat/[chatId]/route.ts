  ...
  try {
    ...
    const resp = String(
      await model
        .call(
          `
        ONLY generate plain sentences without prefix of who is speaking. DO NOT use ${agent.name}: prefix. 

        ${agent.instruction}

        Below are relevant details about ${agent.name}'s past and the conversation you are in.
        ${relevantHistory}
